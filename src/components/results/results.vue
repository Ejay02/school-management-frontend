    ...
    <div class="flex justify-between items-center mb-4">
      ...
      <div class="relative">
        <select
          ...
          class="cursor-pointer appearance-none bg-white border border-gray-300 rounded-md px-4 py-2 pr-8 text-gray-700 font-medium focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-300"
        >
          <option
