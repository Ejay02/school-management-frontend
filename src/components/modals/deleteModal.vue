    ...
    >
      ...
      >
        ...
        <div class="mt-4">
          ...
          <div
            v-if="source === 'chatMessage'"
            class="mt-4 flex items-start gap-2 rounded-md bg-amber-50 px-3 py-2 text-xs text-amber-700"
          >
            <svg
            ...
            <p>Only your own messages can be deleted within 30 minutes.</p>
          </div>
        </div>
