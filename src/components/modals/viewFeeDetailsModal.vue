  ...
  <transition name="fade">
    ...
    >
      ...
      >
        ...
        <div
          class="bg-gradient-to-br from-indigo-500 to-purple-600 hover:from-blue-500 hover:to-purple-500 p-5 rounded-t-xl flex justify-between items-center"
        >
        ...
        <div class="p-6">
          ...
          >
            <div
              class="animate-spin rounded-full h-10 w-10 border-b-2 border-t-2 border-indigo-600"
            ></div>
          </div>

          <div
            v-else-if="feeStructureStore.error"
            class="text-red-500 text-center py-8 bg-red-50 rounded-lg p-4"
          >
          ...
          <div v-else class="space-y-8">
            <!-- Summary Card -->
            <div
              class="cursor-pointer bg-gray-50 rounded-xl p-5 shadow-sm border border-gray-100"
            >
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div class="space-y-1">
                  ...
                  <p class="text-lg font-semibold text-gray-800">
                    {{ selectedFee?.classes?.[0]?.name || "N/A" }}
                  </p>
                </div>
            ...
            <div class="space-y-4 cursor-pointer">
              ...
              >
                <div
                  v-if="
                    selectedFee?.components && selectedFee.components.length > 0
                  "
                >
                  <div
                    v-for="(component, index) in selectedFee.components"
                    :key="index"
                ...
                <div v-else class="p-8 text-center">
                  ...
                  >
                    <i
                      class="fas fa-file-invoice-dollar text-gray-400 text-xl"
                    ></i>
                  </div>
