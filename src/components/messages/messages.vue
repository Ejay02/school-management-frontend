<template>
  <div
    class="rounded border border-gray-300 p-2 w-full shadow-md cursor-pointer"
  >
    <div class="bg-white w-full p-4 rounded">
      <ul role="list" class="divide-y divide-gray-100">
        <li
          ...
          :key="person.email"
          class="flex justify-between gap-x-6 py-5 hover:bg-eduSkyLight -mx-2 px-2 rounded-md"
        >
