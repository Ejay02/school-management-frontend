...
const createCircularChart = () => {
  ...
  const maleRemainder = Math.max(0, 100 - malePercentage);
  const femaleRemainder = Math.max(0, 100 - femalePercentage);
      ...
      datasets: [
        {
          ...
          data: [malePercentage, maleRemainder],
        ...
        },
        {
          ...
          data: [femalePercentage, femaleRemainder],
